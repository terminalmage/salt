...
def compound(tgt, minion_id=None):
    ...
    try:
        return matchers['compound.match'](tgt)
...
def ipcidr(tgt):
    ...
    try:
        return matchers['ipcidr.match'](tgt)
    except Exception as exc:
        log.exception(exc)
        return False
...
def pillar_pcre(tgt, delimiter=DEFAULT_TARGET_DELIM):
    ...
    matchers = salt.loader.matchers(__opts__)
    try:
        return matchers['pillar_pcre.match'](tgt, delimiter=delimiter)
    except Exception as exc:
        log.exception(exc)
        return False
...
def pillar(tgt, delimiter=DEFAULT_TARGET_DELIM):
    ...
    matchers = salt.loader.matchers(__opts__)
    try:
        return matchers['pillar.match'](tgt, delimiter=delimiter)
    except Exception as exc:
        log.exception(exc)
        return False
...
def data(tgt):
    ...
    matchers = salt.loader.matchers(__opts__)
    try:
        return matchers['data.match'](tgt)
    except Exception as exc:
        log.exception(exc)
        return False
...
def grain_pcre(tgt, delimiter=DEFAULT_TARGET_DELIM):
    ...
    matchers = salt.loader.matchers(__opts__)
    try:
        return matchers['grain_pcre.match'](tgt, delimiter=delimiter)
    except Exception as exc:
        log.exception(exc)
        return False
...
def grain(tgt, delimiter=DEFAULT_TARGET_DELIM):
    ...
    matchers = salt.loader.matchers(__opts__)
    try:
        return matchers['grain.match'](tgt, delimiter=delimiter)
    except Exception as exc:
        log.exception(exc)
        return False
...
def list_(tgt, minion_id=None):
    ...
    matchers = salt.loader.matchers(opts)
    try:
        return matchers['list.match'](tgt)
    except Exception as exc:
        log.exception(exc)
        return False
...
def pcre(tgt, minion_id=None):
    ...
    matchers = salt.loader.matchers(opts)
    try:
        return matchers['pcre.match'](tgt)
    except Exception as exc:
        log.exception(exc)
        return False
...
def glob(tgt, minion_id=None):
    ...
    try:
        return matchers['glob.match'](tgt)
    except Exception as exc:
        log.exception(exc)
        return False
